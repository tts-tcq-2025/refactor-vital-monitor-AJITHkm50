...
// Function to evaluate the status of vital signs
int evaluateVitalSigns(float temperature, float pulseRate, float spo2) {
...
int vitalsOk(float temperature, float pulseRate, float spo2) {
    return evaluateVitalSigns(temperature, pulseRate, spo2);
}
